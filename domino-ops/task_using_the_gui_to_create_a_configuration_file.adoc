...
. [[dreizehnter Schritt]]Geben Sie auf der Snapshot-Detailseite die Snapshot-Konfigurationsinformationen an:
+
|===
| Für dieses Feld... | Tun Sie das... 
...
.. Die Anweisungen befinden sich im folgenden Schritt<<thirteenth-step,13>>.
