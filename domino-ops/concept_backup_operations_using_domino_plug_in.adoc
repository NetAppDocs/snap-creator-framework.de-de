...
NOTE: Sie können das Plug-in zwingen, trotz Fehlern mit den Sicherungsvorgängen fortzufahren, wie in Schritt link:task_using_the_gui_to_create_a_configuration_file.html["Aufgabe: Mit der GUI eine Konfigurationsdatei erstellen"] beschrieben.
