...
(J|N)
 a| 
Ermöglicht die Nutzung der IP-Adresse für das Speichersystem. Dies gilt für SnapVault, SnapMirror und die Datensicherungsfunktionen der NetApp Management Console. Die Verwendung von IPs kann Probleme verursachen und sollte nur unter bestimmten Bedingungen erfolgen.
