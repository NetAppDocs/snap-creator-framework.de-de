...
NTAP_DFM_SNAPSHOT_FORMAT
 a| 
 a| 
Optionale Einstellung für das Format der sekundären Snapshot-Kopien bei Verwendung der Datensicherungsfunktion der NetApp Management Console. Diese Option erfordert OnCommand 5.0 oder höher. Erforderliche Variable:
...
* Aufbewahrungstyp: %R
* Datensatzbezeichnung: %L
* Speicherkontroller: %H
* Datenträgername: %N
* Anwendungsspezifische Daten: %A


Wenn diese Option nicht festgelegt ist, wird die Standardbenennungskonvention für die Datensicherungsfunktion der NetApp Management Console verwendet. Die Namenskonvention kann nur bei der Erstellung des Datensatzes festgelegt werden.
