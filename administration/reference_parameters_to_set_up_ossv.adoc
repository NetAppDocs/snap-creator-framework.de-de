...
NTAP_OSSV_FS_SNAPSHOT_CREATE_CMD
 a| 
 a| 
Führen Sie diese Skripte oder Befehle während oder vor dem OSSV-Sicherungsprozess aus, wobei ## eine Zahl von 01 bis 99 ist. Dies kann verwendet werden, um mit OSSV Snapshot-Kopien des Backup-Dateisystems zu erstellen.
